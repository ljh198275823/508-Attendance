...
namespace LJH.Attendance.UI
{
    public partial class FrmStaffCategoryMaster : FrmMasterBase
    {
        ...
        {
            base.Init();
            this.ContextMenu.Items["mnu_Add"].Enabled = Operator.CurrentOperator.Permit(Permission.EditStaffCategory);
            this.ContextMenu.Items["mnu_Delete"].Enabled = Operator.CurrentOperator.Permit(Permission.EditStaffCategory);
