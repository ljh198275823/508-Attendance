namespace Ralid.Attendance.UI
{
    partial class FrmDepartmentMaster
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.txtParentID = new Ralid.GeneralLibrary.WinformControl.DBCTextBox(this.components);
            this.txtMemo = new Ralid.GeneralLibrary.WinformControl.DBCTextBox(this.components);
            this.txtDeptName = new Ralid.GeneralLibrary.WinformControl.DBCTextBox(this.components);
            this.txtDeptID = new Ralid.GeneralLibrary.WinformControl.DBCTextBox(this.components);
