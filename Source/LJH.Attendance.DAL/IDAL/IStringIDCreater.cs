...
namespace LJH.Attendance.DAL.IDAL
{
    ...
    /// 自动编号生成器接口
    /// </summary>
    public interface IStringIDCreater
    {
        /// <summary>
        /// 生成自动编号
        /// </summary>
        ...
        /// <returns></returns>
        string CreateID(string prefix, string dateFormat, int serialLen, string type);
        ...
        /// <param name="type">自动编号的类型</param>
        /// <returns></returns>
        string CreateID(string prefix, int serialLen, string type);
    }
}
